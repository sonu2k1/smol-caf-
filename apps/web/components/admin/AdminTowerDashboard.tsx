...
export const AdminTowerDashboard: React.FC<AdminTowerProps> = () => {
  const [activeTab, setActiveTab] = useState<
    "overview" | "orders" | "tables" | "menu" | "customers" | "staff" | "payments" | "settings"
  >("overview");
  ...
  return (
    <div className="min-h-screen bg-[#141211] text-[#FDFBF7] flex">
      {/* Sidebar Navigation */}
      <aside className="w-64 shrink-0 border-r border-stone-800 bg-[#1A1715] flex flex-col justify-between hidden md:flex">
        <div className="p-5 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-serif text-lg font-black tracking-tight text-white lowercase">
                smol tower
              </h2>
              <p className="font-mono text-[10px] text-[#C9AE8B]">Admin Control Hub</p>
            </div>
          </div>
          ...
          <nav className="space-y-1.5 text-xs font-medium">
            {[
              ...
              { id: "tables", label: "Tables & Zones", icon: Armchair, badge: "12" },
        ...
        <div className="border-t border-stone-800 p-4 space-y-2">
          <div className="flex items-center justify-between text-xs">
            <span className="font-mono text-stone-400">Owner Access</span>
            <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
          </div>
          <Link
            href="/menu"
            className="flex items-center justify-between rounded-xl border border-stone-800 bg-stone-900 px-3 py-2 text-xs text-stone-300 hover:bg-stone-800 transition"
          >
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        {/* Top App Header */}
        <header className="sticky top-0 z-30 border-b border-stone-800 bg-[#1C1917]/95 px-6 py-4 backdrop-blur-md flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black tracking-tight text-white capitalize">
                ...
                {activeTab === "customers" && "Smol Club Loyalty & Customer CRM"}
              ...
              <p className="font-mono text-[10px] text-[#C9AE8B]">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl border border-stone-800 bg-stone-900 px-3 py-1.5 text-xs text-stone-300 hover:bg-stone-800 transition"
            >
          ...
          <div className="p-6 space-y-6 max-w-7xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3.5">
              {[
                ...
                <div
                  key={idx}
                  className="rounded-2xl border border-stone-800 bg-[#1A1715] p-4 shadow-sm space-y-1"
                >
                  <span className="block font-mono text-[9px] uppercase font-bold text-stone-400">
                    {kpi.label}
                  </span>
                  <div
                  ...
                  <span className="block text-[10px] text-stone-500 font-mono">{kpi.trend}</span>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="rounded-3xl border border-stone-800 bg-[#1A1715] p-5 shadow-sm space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-serif text-base font-bold text-white">Orders Over Time</h3>
                    <p className="font-mono text-xs text-stone-400">Hourly ticket load (8AM - 10PM)</p>
                  </div>
                  <span className="rounded-full bg-stone-800 px-2.5 py-0.5 text-xs font-mono text-[#F2C84B]">
                    Peak: 4PM - 6PM
                  </span>
                </div>

                {/* SVG Bar Chart */}
                <div className="h-44 w-full flex items-end justify-between gap-1.5 pt-4 pb-2 border-b border-stone-800">
                  {[
                    { hour: "8a", orders: 4 },
                    { hour: "9a", orders: 7 },
                    { hour: "10a", orders: 12 },
                    ...
                    return (
                      <div key={i} className="flex-1 flex flex-col items-center gap-1 group">
                        ...
                        />
                        <span className="text-[9px] font-mono text-stone-500">{bar.hour}</span>
                      </div>
                    );
                  })}
                </div>
              ...
              <div className="rounded-3xl border border-stone-800 bg-[#1A1715] p-5 shadow-sm space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-serif text-base font-bold text-white">Revenue Trajectory</h3>
                    <p className="font-mono text-xs text-stone-400">Cumulative day revenue vs 7-day average</p>
                  </div>
              ...
              <div className="rounded-3xl border border-stone-800 bg-[#1A1715] p-5 shadow-sm space-y-4">
                <h3 className="font-serif text-base font-bold text-white">Best-Selling Items</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="rounded-3xl border border-stone-800 bg-[#1A1715] p-5 shadow-sm space-y-3">
                  <h3 className="font-serif text-sm font-bold text-white">Zone Utilization</h3>
                  <div className="space-y-2.5 text-xs">
                    {[
                      ...
                      <div key={idx} className="flex items-center justify-between">
                        <span className="text-stone-300">{z.zone}</span>
                ...
                <div className="rounded-3xl border border-stone-800 bg-[#1A1715] p-5 shadow-sm space-y-3">
                  <h3 className="font-serif text-sm font-bold text-white">Payment Split</h3>
                  <div className="space-y-2.5 text-xs">
                    {[
                      ...
                      <div key={idx} className="flex items-center justify-between">
                        <span className="text-stone-300">{p.mode}</span>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="rounded-xl border border-stone-800 bg-stone-900 pl-9 pr-4 py-2 text-xs text-white placeholder:text-stone-500 focus:border-[#B72E35] focus:outline-none"
                />
              </div>
            </div>
              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-stone-800 font-mono">
                  {orders
                    ...
                    .map((o) => (
                      <tr key={o.id} className="hover:bg-stone-900/50 transition">
                        <td className="p-3.5 font-bold text-white">#{o.orderNo}</td>
                        <td className="p-3.5">
                          <span className="text-[#F2C84B] font-bold">Table {o.tableLabel}</span>
                          <span className="block text-[10px] text-stone-500">{o.zone}</span>
                        </td>
                        <td className="p-3.5 max-w-xs truncate text-stone-300 font-sans">
                          {o.items.join(", ")}
                        </td>
                        <td className="p-3.5">
                          <span
                        ...
                        <td className="p-3.5 font-bold font-serif text-white">₹{o.totalRupees}</td>
                        <td className="p-3.5 text-[11px] text-stone-400">{o.paymentStatus}</td>
        ...
        {activeTab === "tables" && (
          <div className="p-6 space-y-6 max-w-7xl">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold">12 Dining Tables Floor Map</h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {Array.from({ length: 12 }, (_, i) => {
                ...
                return (
                  <div
                    key={label}
                    className={`rounded-3xl border p-4 text-left transition-all relative flex flex-col justify-between h-44 ${
                      isOccupied
                        ? "border-[#B72E35] bg-[#1A1715] shadow-md ring-1 ring-[#B72E35]/40"
                        : "border-stone-800 bg-[#171514] opacity-80"
                    }`}
                  >
                    <div>
                      <div className="flex items-center justify-between">
                        <span className="font-mono text-xl font-black text-white">T-{label}</span>
                        <span
                          className={`h-2 w-2 rounded-full ${
                            isOccupied ? "bg-emerald-500 animate-pulse" : "bg-stone-600"
                          }`}
                        />
                      </div>
                      <span className="mt-1 block text-xs font-bold text-[#F2C84B]">
                        {config.zone}
                      </span>
                    ...
                    <div className="space-y-1.5 pt-2">
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-1 rounded-xl bg-stone-800 py-1.5 text-[11px] font-mono text-stone-300 hover:bg-stone-700 transition"
                      >
                        <Tag className="h-3 w-3 text-[#F2C84B]" />
                        <span>JSON Tag</span>
                      </button>
                      ...
                      <Link
                        href={`/t/table-${label}`}
                        className="w-full flex items-center justify-center gap-1 rounded-xl border border-stone-700 bg-stone-900 py-1.5 text-[11px] font-mono text-stone-300 hover:bg-stone-800 transition"
                      >
        ...
        {activeTab === "menu" && (
          <div className="p-6 space-y-4 max-w-7xl">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold">Menu Items Catalog (59 Items)</h2>
                <p className="font-mono text-xs text-stone-400">
                  ...
                  {[
                    ...
                    return (
                      <tr key={item.id} className="hover:bg-stone-900/50 transition">
                        ...
                        <td className="p-3.5 font-mono text-stone-400">{item.cat}</td>
                        <td className="p-3.5 font-serif font-bold text-[#F2C84B]">{item.price}</td>
                        <td className="p-3.5 font-mono text-stone-400">{item.diet}</td>
                        <td className="p-3.5 text-right">
                          <button
        ...
        {activeTab === "customers" && (
          <div className="p-6 space-y-6 max-w-7xl">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold">Smol Club Loyalty &amp; Rewards</h2>
                <p className="font-mono text-xs text-stone-400">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="rounded-3xl border border-stone-800 bg-[#1A1715] p-5 space-y-2">
                <span className="font-mono text-[10px] text-stone-400 uppercase">TIER 1: SEEDLING</span>
                <p className="font-serif text-2xl font-bold text-amber-300">0 - 100 Points</p>
                <p className="text-xs text-stone-400">Earn 1 pt per ₹10 spent. Free cookie at 100 pts.</p>
              </div>

              <div className="rounded-3xl border border-stone-800 bg-[#1A1715] p-5 space-y-2">
                <span className="font-mono text-[10px] text-stone-400 uppercase">TIER 2: REGULAR</span>
                <p className="font-serif text-2xl font-bold text-[#F2C84B]">101 - 500 Points</p>
                <p className="text-xs text-stone-400">1.25x multiplier + 10% off artisanal coffees.</p>
              </div>

              <div className="rounded-3xl border border-stone-800 bg-[#1A1715] p-5 space-y-2">
                <span className="font-mono text-[10px] text-stone-400 uppercase">TIER 3: SMOL INSIDER</span>
                <p className="font-serif text-2xl font-bold text-emerald-400">500+ Points</p>
                <p className="text-xs text-stone-400">Secret chalkboard brew tastings &amp; table reservations.</p>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === "staff" && (
          <div className="p-6 space-y-6 max-w-7xl">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold">Staff Role-Based Access Control (RBAC)</h2>
                <p className="font-mono text-xs text-stone-400">
                ...
                <tbody className="divide-y divide-stone-800 font-mono">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-stone-900/50 transition">
                      <td className="p-3.5 font-bold text-white font-sans">{s.role}</td>
                      <td className="p-3.5 text-[#F2C84B]">{s.portal}</td>
                      <td className="p-3.5 font-black text-stone-300">{s.pin}</td>
                      <td className="p-3.5 text-stone-400 font-sans">{s.perm}</td>
                      <td className="p-3.5 text-right">
                        <span className="rounded-full bg-emerald-950 px-2.5 py-0.5 text-[10px] font-bold text-emerald-400 border border-emerald-800">
                          {s.status}
                        </span>
                      </td>
                    </tr>
        ...
        {activeTab === "settings" && (
          <div className="p-6 space-y-6 max-w-3xl">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold">UPI Gateway &amp; Merchant ID Setup</h2>
                <p className="font-mono text-xs text-stone-400">
            ...
            {settingsSaved && (
              <div className="rounded-2xl border border-emerald-800 bg-emerald-950/60 p-4 text-xs font-serif text-emerald-300 animate-scale-in">
            ...
            <form onSubmit={handleUpdateMerchantSettings} className="space-y-4">
              <div className="rounded-3xl border border-stone-800 bg-[#1A1715] p-6 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-stone-700 bg-stone-900 px-4 py-3 font-mono text-sm text-white focus:border-[#B72E35] focus:outline-none"
                    required
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-stone-700 bg-stone-900 px-4 py-3 text-sm text-white focus:border-[#B72E35] focus:outline-none"
                    required
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-stone-700 bg-stone-900 px-4 py-3 font-mono text-xs text-white focus:border-[#B72E35] focus:outline-none"
                    />
                  </div>
        ...
        {activeTab === "payments" && (
          <div className="p-6 space-y-4 max-w-7xl">
            <h2 className="text-xl font-bold">Payments Reconciliation &amp; Settlement Log</h2>
            <div className="rounded-3xl border border-stone-800 bg-[#1A1715] overflow-hidden">
              <table className="w-full text-left text-xs">
                <thead className="bg-stone-900 text-[10px] uppercase tracking-wider font-mono text-stone-400 border-b border-stone-800">
                  <tr>
                ...
                <tbody className="divide-y divide-stone-800 font-mono">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-stone-900/50 transition">
                      <td className="p-3.5 font-bold text-stone-200">{t.txn}</td>
                      <td className="p-3.5 text-[#F2C84B]">{t.mode}</td>
                      <td className="p-3.5 font-serif font-bold text-white">{t.amt}</td>
                      <td className="p-3.5 text-stone-400">{t.ord}</td>
                      <td className="p-3.5">
